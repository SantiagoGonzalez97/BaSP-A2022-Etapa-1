...
=======
    if (isNaN(sumaB)){
>>>>>>> 204f86ad875bef71bea9f56ae92870ba9c045eb1
        alert('Exercise 6.b): ' + 'Parameter Error\nIts not a number');
        return NaN;
    }
<<<<<<< HEAD
    return a + b;
=======
>>>>>>> 02e7f51810561519d326ecd88ac40fb42da94c7c
>>>>>>> 204f86ad875bef71bea9f56ae92870ba9c045eb1
}
myVarA = sumaB(1,2)
...
//c) Convertir la validación del ejercicio 6d) en una función separada y llamarla dentro de la función suma probando que todo siga funcionando igual.
...
function validateInteger(a,b){
    if (!validateInteger(a) || !validateInteger(b)){
        ...
        if (!validateInteger(b)) {
            ...
            return console.log('Exercise 6.e): ' +  (a + b));
        }
    }
<<<<<<< HEAD
    function sumaD(a,b){
